...
/* BinSearchDriver.java tests linear and binary search. It tests the iterative and recursive methods.
 */
...
public class BinSearchDriver {
	...
	public final static String FILE_AND_PATH = "c:\\/Users/alisc/Downloads/longwords.txt";
	/* 
...
//		tryBinarySearch(wordsToSearch, "ZZZ");
//		
//		
//		tryLinearSearch(wordsToSearch, "ABANDONMENT");
//		recLinearSearch(wordsToSearch, "ABANDONMENT");
//		tryBinarySearch(wordsToSearch, "ABANDONMENT");
//		recBinarySearch(wordsToSearch, "ABANDONMENT");
//		
//		tryLinearSearch(wordsToSearch, "ABDICATION");
//		recLinearSearch(wordsToSearch, "ABDICATION");
//		tryBinarySearch(wordsToSearch, "ABDICATION");
//		recBinarySearch(wordsToSearch, "ABDICATION");
//		
//		
//		tryLinearSearch(wordsToSearch, "ANTHRACENE");
//		recLinearSearch(wordsToSearch, "ANTHRACENE");
//		tryBinarySearch(wordsToSearch, "ANTHRACENE");
//		recBinarySearch(wordsToSearch, "ANTHRACENE");
//		
//		tryLinearSearch(wordsToSearch, "GARBAGEMAN");
////		recLinearSearch(wordsToSearch, "GARBAGEMAN");
//		tryBinarySearch(wordsToSearch, "GARBAGEMAN");
//		recBinarySearch(wordsToSearch, "GARBAGEMAN");
//		
//		tryLinearSearch(wordsToSearch, "GOO");
////		recLinearSearch(wordsToSearch, "ZOO");
//		tryBinarySearch(wordsToSearch, "JOO");
//		recBinarySearch(wordsToSearch, "BOO");
//		recBinarySearch(wordsToSearch, "COMPUTER SCIENCE IS THE BEST");
//		
//		tryLinearSearch(wordsToSearch, "ZYGOMORPHY");
////		recLinearSearch(wordsToSearch, "ZYGOMORPHY");
//		tryBinarySearch(wordsToSearch, "ZYGOMORPHY");
//		recBinarySearch(wordsToSearch, "ZYGOMORPHY");
	}
...
//			System.out.println( target + ":" + e.getMessage());
	...
	private static void recBinarySearch(String[] wordsToSearch, String target) {
		//Todo: Build a LinearSearch class that inherits from SearchAlgorithm, and put it in the same directory as this class to successfully compile
		SearchAlgorithm bs = new BinarySearch();
...
//			System.out.println( target + ":" + e.getMessage());
	...
	private static void recLinearSearch(String[] wordsToSearch, String target) {
		//Todo: Build a LinearSearch class that inherits from SearchAlgorithm, and put it in the same directory as this class to successfully compile
		SearchAlgorithm bs = new LinearSearch();
